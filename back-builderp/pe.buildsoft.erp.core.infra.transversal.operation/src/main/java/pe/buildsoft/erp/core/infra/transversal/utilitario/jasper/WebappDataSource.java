 ...
 * </ul> 
 * 
 * La Class WebappDataSource.
 *
 * @author Teodor Danciu (teodord@users.sourceforge.net)
 * @version $Id: WebappDataSource.java 5876 2013-01-07 19:05:05Z teodord $
 */
public class WebappDataSource implements JRDataSource {
	...
	private Object[][] data =
		{
			...
			{"Pucallpa", new Integer(7), "James Peterson", "231 Upland Pl."},
			{"Pucallpa", new Integer(48), "Robert White", "549 Seventh Av."},
			{"Pucallpa", new Integer(7), "James Peterson", "231 Upland Pl."},
			{"Iquitos", new Integer(7), "James Peterson", "231 Upland Pl."},
			{"Iquitos", new Integer(48), "Robert White", "549 Seventh Av."},
			{"Iquitos", new Integer(7), "James Peterson", "231 Upland Pl."},
			{"Tarapoto", new Integer(45), "Janet May", "396 Seventh Av."},
			{"Tarapoto", new Integer(42), "Robert Ott", "503 Seventh Av."},
			{"Tarapoto", new Integer(25), "Sylvia Steel", "269 College Av."},
			{"Tarapoto", new Integer(18), "Sylvia Fuller", "158 - 20th Ave."},
			{"Tarapoto", new Integer(5), "Laura Miller", "294 Seventh Av."},{"Pucallpa", new Integer(7), "James Peterson", "231 Upland Pl."},
			{"Lima", new Integer(48), "Robert White", "549 Seventh Av."},
			{"Lima", new Integer(7), "James Peterson", "231 Upland Pl."},
			{"Lima", new Integer(7), "James Peterson", "231 Upland Pl."},
			{"Lima", new Integer(48), "Robert White", "549 Seventh Av."},
			{"Lima", new Integer(7), "James Peterson", "231 Upland Pl."},
			{"Lima", new Integer(45), "Janet May", "396 Seventh Av."},
			{"Lima", new Integer(42), "Robert Ott", "503 Seventh Av."},
			{"Lima", new Integer(25), "Sylvia Steel", "269 College Av."},
			{"Lima", new Integer(18), "Sylvia Fuller", "158 - 20th Ave."},
			{"Lima", new Integer(5), "Laura Miller", "294 Seventh Av."}
		};
	...
	/**
	 * Instancia un nuevo webapp data source.
	 */

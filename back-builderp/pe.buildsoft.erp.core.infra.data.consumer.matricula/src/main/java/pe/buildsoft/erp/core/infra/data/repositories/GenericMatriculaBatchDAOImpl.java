 ...
 * @since Rep v1..0
 */
public class GenericMatriculaBatchDAOImpl<K, T> extends GenericOperacionDAOImpl<K, T> {

	private Logger log = LoggerFactory.getLogger(GenericMatriculaBatchDAOImpl.class);
	/** El objeto entity manager. */
	@PersistenceContext(unitName = ConfiguracionEntityManagerUtil.PU_MATRICULA_BATCH)
	private EntityManager entityManager;

	public GenericMatriculaBatchDAOImpl() {
		// Constructor
	}

	@Override
	public Connection getConexionDS() throws NamingException, SQLException {
		return getConexionDSPer("java:jboss/datasources/matriculaDS");
	}

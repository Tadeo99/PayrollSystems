...
/**
 * La Class CursoNotaPeriodoPromRestController.
 * <ul>
 ...
 */
@Tag(name = "/cursoNotaPeriodoProm", description = "Nota Service")
...
@Path("/cursoNotaPeriodoProm")
@Consumes(MediaType.APPLICATION_JSON)
@Produces(MediaType.APPLICATION_JSON)
public interface ICursoNotaPeriodoPromRestController {

	@POST
	Response crear(CursoNotaPeriodoPromDTO obj);

	@PUT
	@Path("/{id}")
	Response modificar(CursoNotaPeriodoPromDTO obj);

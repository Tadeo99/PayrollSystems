...
/**
 * La Class CursoNotaPeriodoRestController.
 * <ul>
 ...
 */
@Tag(name = "/cursoNotaPeriodo", description = "Nota Service")
...
@Path("/cursoNotaPeriodo")
@Consumes(MediaType.APPLICATION_JSON)
@Produces(MediaType.APPLICATION_JSON)
public interface ICursoNotaPeriodoRestController {

	@POST
	Response crear(CursoNotaPeriodoDTO obj);

	@PUT
	@Path("/{id}")
	Response modificar(CursoNotaPeriodoDTO obj);

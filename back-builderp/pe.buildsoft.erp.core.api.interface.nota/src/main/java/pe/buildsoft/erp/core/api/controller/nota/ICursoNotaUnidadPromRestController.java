...
/**
 * La Class CursoNotaUnidadPromRestController.
 * <ul>
 ...
 */
@Tag(name = "/cursoNotaUnidadProm", description = "Nota Service")
...
@Path("/cursoNotaUnidadProm")
@Consumes(MediaType.APPLICATION_JSON)
@Produces(MediaType.APPLICATION_JSON)
public interface ICursoNotaUnidadPromRestController {

	@POST
	Response crear(CursoNotaUnidadPromDTO obj);

	@PUT
	@Path("/{id}")
	Response modificar(CursoNotaUnidadPromDTO obj);

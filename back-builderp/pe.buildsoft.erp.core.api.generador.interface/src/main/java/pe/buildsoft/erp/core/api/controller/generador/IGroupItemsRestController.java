 ...
 * @since SIAA-CORE 2.1
 */
@Tag(name = "/group/items", description = "Generador Service")
@OpenAPIDefinition(info = @Info(title = "Servicios de Generador", version = "0.0", description = "Security Generador"), tags = {
		@Tag(name = "Admision Service", description = "Servicios de Generador") })
@Path("/group/items")

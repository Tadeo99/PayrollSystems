...
/**
 * La Class IConfigGrupoServicioRestController .
 * <ul>
...
public interface IGrupoNegocioRestController {

	@POST
	@Path("/{idProyecto}/grupoNegocio")
	Response crear(@PathParam("idProyecto") String idProyecto, GrupoNegocioDTO obj);

	@PUT
	@Path("/{idProyecto}/grupoNegocio/{id}")
	Response modificar(@PathParam("idProyecto") String idProyecto, GrupoNegocioDTO obj);

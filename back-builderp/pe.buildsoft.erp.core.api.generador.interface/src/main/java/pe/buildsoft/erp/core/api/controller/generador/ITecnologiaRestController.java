...
/**
 * La Class ITecnologiaRestController .
 * <ul>
...
public interface ITecnologiaRestController {

	@POST
	Response crear(TecnologiaDTO tecnologia);

	@PUT
	@Path("/{id}")
	Response modificar(TecnologiaDTO tecnologia);

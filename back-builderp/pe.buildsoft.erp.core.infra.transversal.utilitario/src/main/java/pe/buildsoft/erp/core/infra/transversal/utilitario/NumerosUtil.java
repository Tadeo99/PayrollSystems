...
public class NumerosUtil {
	...
	public static boolean estaDentroRango(BigDecimal numeroComparar, BigDecimal numeroIntervalo1,
			BigDecimal numeroIntervalo2) {
	...
	public static boolean estaDentroRango(long numeroComparar, long numeroIntervalo1, long numeroIntervalo2) {
		boolean respuesta = false;
		respuesta = numeroComparar >= (numeroIntervalo1) && numeroComparar <= (numeroIntervalo2);
		return respuesta;
	}

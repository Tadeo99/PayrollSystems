...
public interface IContratoRestController {

	@POST
	@Path("/{idPersonal}/contrato")
	Response crear(@PathParam("idPersonal") String idPersonal, ContratoDTO obj);

	@PUT
	@Path("/{idPersonal}/contrato/{id}")
	Response modificar(@PathParam("idPersonal") String idPersonal, ContratoDTO obj);

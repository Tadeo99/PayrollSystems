...
public interface IHistorialCargoAreaRestController {

	@POST
	@Path("/{idPersonal}/historialCargoArea")
	Response crear(@PathParam("idPersonal") String idPersonal,HistorialCargoAreaDTO obj);

	@PUT
	@Path("/{idPersonal}/historialCargoArea/{id}")
	Response modificar(@PathParam("idPersonal") String idPersonal,HistorialCargoAreaDTO obj);

...
public interface IHistorialBasicoRestController {

	@POST
	@Path("/{idPersonal}/historialBasico")
	Response crear(@PathParam("idPersonal") String idPersonal, HistorialBasicoDTO obj);

	@PUT
	@Path("/{idPersonal}/historialBasico/{id}")
	Response modificar(@PathParam("idPersonal") String idPersonal, HistorialBasicoDTO obj);

...
public interface IDireccionPersonalRestController {

	@POST
	@Path("/{idPersonal}/direccion")
	Response crear(@PathParam("idPersonal") String idPersonal, DireccionPersonalDTO obj);

	@PUT
	@Path("/{idPersonal}/direccion/{id}")
	Response modificar(@PathParam("idPersonal") String idPersonal, DireccionPersonalDTO obj);

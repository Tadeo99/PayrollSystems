...
public interface IAsociarCentroCostoRestController {

	@POST
	@Path("/{idPersonal}/centroCosto")
	Response crear(@PathParam("idPersonal") String idPersonal, AsociarCentroCostoDTO obj);

	@PUT
	@Path("/{idPersonal}/centroCosto/{id}")
	Response modificar(@PathParam("idPersonal") String idPersonal, AsociarCentroCostoDTO obj);

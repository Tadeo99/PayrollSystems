 ...
 */
@Tag(name = "/institucion", description = "Escalafon Service")
...
public interface IInstitucionRestController {

	@POST
	Response crear(InstitucionDTO obj);

	@PUT
	@Path("/{id}")
	Response modificar(InstitucionDTO obj);

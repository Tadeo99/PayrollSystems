...
public interface IBeneficiariosRestController {

	@POST
	@Path("/{idPersonal}/beneficiario")
	Response crear(@PathParam("idPersonal") String idPersonal, BeneficiariosDTO obj);

	@PUT
	@Path("/{idPersonal}/beneficiario/{id}")
	Response modificar(@PathParam("idPersonal") String idPersonal, BeneficiariosDTO obj);

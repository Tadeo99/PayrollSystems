 ...
 */
@Tag(name = "/grado", description = "Admision Service")
...
public interface IGradoRestController {

	@POST
	Response crear(GradoDTO obj);

	@PUT
	@Path("/{id}")
	Response modificar(GradoDTO obj);

 ...
 */
@Tag(name = "/postulante", description = "Admision Service")
...
public interface IPostulanteRestController {

	@POST
	Response crear(PostulanteDTO obj);

	@PUT
	@Path("/{id}")
	Response modificar(PostulanteDTO obj);

 ...
 */
@Stateless
public class GrupoDaoImpl extends GenericMatriculaDAOImpl<Long, Grupo> implements GrupoDaoLocal {

	/*
	 * (non-Javadoc)
	 * 
	 * @see
	 * pe.com.builderp.core.service.matricula.dao.local.GrupoDaoLocal#listarGrupo(pe
	 * .com.builderp.core.service.matricula.model.jpa.Grupo)
	 */
	@Override
	public List<Grupo> listar(BaseSearch filtro) {
	...
	/**
	 * Generar query lista Grupo.
	 *
	 * @param GrupoDTO   el grupo
	...
	private Query generarQuery(BaseSearch filtro, boolean esContador) {
		...
		if (esContador) {
			jpaql.append(" select count(o.idGrupo) from Grupo o where 1=1 ");
		} else {
			jpaql.append(" select o from Grupo o where 1=1 ");
		}
	 ...
	 * 
	 * @see
	 * pe.com.builderp.core.service.matricula.dao.local.GrupoDaoLocal#contarListar{
	 ...
	 * 
	 * @see
	 * pe.com.builderp.core.service.matricula.dao.local.GrupoDaoLocal#generarIdGrupo
	 * ()
	 */
	@Override
	public Long generarId() {
		var resultado = 1L;
		var query = createQuery("select max(o.idGrupo) from Grupo o", null);
	...
	@Override
	public Grupo find(Grupo filtro) {
		Grupo resultado = new Grupo();
		var parametros = new HashMap<String, Object>();
		var ejecutarQuery = false;
		var jpaql = new StringBuilder();
		jpaql.append(" from Grupo o  where 1=1 ");
		...
		if (ejecutarQuery) {
			...
			List<Grupo> listaObj = query.getResultList();

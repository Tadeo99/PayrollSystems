 ...
 * @since Rep v1..0
 */
public class GenericMatriculaDAOImpl<K, T> extends GenericOperacionDAOImpl<K, T> {

	private Logger log = LoggerFactory.getLogger(GenericMatriculaDAOImpl.class);
	/** El objeto entity manager. */
	@PersistenceContext(unitName = ConfiguracionEntityManagerUtil.PU_MATRICULA)
	private EntityManager entityManager;

	public GenericMatriculaDAOImpl() {
		// Constructor
	}

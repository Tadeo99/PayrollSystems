 ...
 */
@Tag(name = "/planPagos", description = "Pago Service")
...
public interface IPlanPagosRestController {

	@POST
	Response crear(@Context HttpHeaders httpHeaders, PlanPagosDTO obj);

	@POST
	@Path("/obtenerPlanPagosByIdAlumno")
	Response listarPlanPagos(PlanPagosDTO planPagos);

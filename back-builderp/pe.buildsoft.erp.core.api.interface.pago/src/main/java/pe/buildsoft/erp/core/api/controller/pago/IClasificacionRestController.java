 ...
 */
@Tag(name = "/clasificacion", description = "Pago Service")
...
public interface IClasificacionRestController {

	@POST
	Response crear(ClasificacionDTO obj);

	@PUT
	@Path("/{id}")
	Response modificar(ClasificacionDTO obj);
	...
	@POST
	@Path("/find")
	Response find(ClasificacionDTO filtro);
}
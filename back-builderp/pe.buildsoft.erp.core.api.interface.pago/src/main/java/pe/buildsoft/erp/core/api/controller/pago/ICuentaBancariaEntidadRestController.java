 ...
 */
@Tag(name = "/cuentaBancariaEntidad", description = "Pago Service")
...
public interface ICuentaBancariaEntidadRestController {

	@POST
	Response crear(CuentaBancariaEntidadDTO obj);

	@PUT
	@Path("/{id}")
	Response modificar(CuentaBancariaEntidadDTO obj);

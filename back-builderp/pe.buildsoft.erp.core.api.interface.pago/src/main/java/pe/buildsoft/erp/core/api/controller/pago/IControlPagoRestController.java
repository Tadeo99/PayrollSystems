 ...
 */
@Tag(name = "/controlPago", description = "Pago Service")
...
public interface IControlPagoRestController {

	@POST
	Response crear(@Context HttpHeaders httpHeaders, ControlPagoDTO obj);

 ...
 */
@Tag(name = "/catalogoCuenta", description = "Pago Service")
...
public interface ICatalogoCuentaRestController {

	@POST
	Response crear(@Context HttpHeaders httpHeaders, CatalogoCuentaDTO obj);

	@PUT
	@Path("/{id}")
	Response modificar(@Context HttpHeaders httpHeaders, CatalogoCuentaDTO obj);
	...
	@POST
	@Path("/find")
	Response find(CatalogoCuentaDTO filtro);
}
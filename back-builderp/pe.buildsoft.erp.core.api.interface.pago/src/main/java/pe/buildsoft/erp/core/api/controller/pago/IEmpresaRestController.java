 ...
 */
@Tag(name = "/empresa", description = "Pago Service")
...
public interface IEmpresaRestController {

	@POST
	Response crear(EmpresaDTO obj);

	@PUT
	@Path("/{id}")
	Response modificar(EmpresaDTO obj);
	...
	@POST
	@Path("/find")
	Response find(EmpresaDTO filtro);

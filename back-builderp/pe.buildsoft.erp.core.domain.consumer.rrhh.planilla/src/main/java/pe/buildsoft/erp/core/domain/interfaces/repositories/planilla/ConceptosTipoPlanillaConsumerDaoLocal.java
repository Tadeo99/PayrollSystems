 ...
 */
@Local
public interface ConceptosTipoPlanillaConsumerDaoLocal extends GenericDAOLocal<String, ConceptosTipoPlanilla> {

	List<ConceptosTipoPlanilla> getFormulaConceptosTipo();
	/**

...
/**
 * La Class IepsPersonalRestController.
 * <ul>
...
public interface IEpsPersonalRestController {

	@POST
	@Path("/{idPersonal}/eps")
	Response crear(@PathParam("idPersonal") String idPersonal, EPSPersonalDTO obj);

	@PUT
	@Path("/{idPersonal}/eps/{id}")
	Response modificar(@PathParam("idPersonal") String idPersonal, EPSPersonalDTO obj);

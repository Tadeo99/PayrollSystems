...
/**
 * La Class ITareoPersonalRestController.
 * <ul>
...
public interface ITareoPersonalRestController {

	@POST
	@Path("/{idPersonal}/tareo")
	Response crear(@PathParam("idPersonal") String idPersonal, TareoPersonalDTO obj);

	@PUT
	@Path("/{idPersonal}/tareo/{id}")
	Response modificar(@PathParam("idPersonal") String idPersonal, TareoPersonalDTO obj);

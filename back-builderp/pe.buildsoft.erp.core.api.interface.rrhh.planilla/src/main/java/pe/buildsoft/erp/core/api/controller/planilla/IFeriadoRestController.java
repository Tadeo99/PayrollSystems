...
/**
 * La Class IFeriadoRestController.
 * <ul>
 ...
 */
@Tag(name = "/feriado", description = "Planilla Service")
...
public interface IFeriadoRestController {

	@POST
	Response crear(FeriadoDTO obj);

	@PUT
	@Path("/{id}")
	Response modificar(FeriadoDTO obj);

...
/**
 * La Class IVacacionesRestController.
 * <ul>
 ...
 */
@Tag(name = "/vacacion", description = "Planilla Service")
...
public interface IVacacionesRestController {

	@POST
	@Path("/{idPersonal}/vacacion")
	Response crear(@PathParam("idPersonal") String idPersonal, VacacionesDTO obj);

	@PUT
	@Path("/{idPersonal}/vacacion/{id}")
	Response modificar(@PathParam("idPersonal") String idPersonal, VacacionesDTO obj);
	...
	@GET
	@Path("/vacaciones")
	Response paginadorAll(@Context HttpHeaders headers, @Context UriInfo info);
}
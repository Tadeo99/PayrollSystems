...
public interface IVariableConfRestController {

	@POST
	@Path("/{idTipoPlanilla}/variableGrupo")
	Response crear(@PathParam("idTipoPlanilla") String idTipoPlanilla, VariableConfDTO obj);

	@PUT
	@Path("/{idTipoPlanilla}/variableGrupo/{id}")
	Response modificar(@PathParam("idTipoPlanilla") String idTipoPlanilla, VariableConfDTO obj);

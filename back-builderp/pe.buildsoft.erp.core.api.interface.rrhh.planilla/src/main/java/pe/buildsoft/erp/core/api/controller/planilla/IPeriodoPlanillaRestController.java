 ...
 */
@Tag(name = "/periodoPlanilla", description = "Planilla Service")
...
public interface IPeriodoPlanillaRestController {

	@POST
	Response crear(PeriodoPlanillaDTO obj);

	@PUT
	@Path("/{id}")
	Response modificar(PeriodoPlanillaDTO obj);
	...
	@POST // TODO:VER SI VA
	@Path("/find")
	Response find(PeriodoPlanillaDTO filtro);
}
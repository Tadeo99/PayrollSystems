...
/**
 * La Class IAdelantoRestController.
 * <ul>
...
public interface IAdelantoRestController {

	@POST
	@Path("/{idPersonal}/adelanto")
	Response crear(@PathParam("idPersonal") String idPersonal, AdelantoDTO obj);

	@PUT
	@Path("/{idPersonal}/adelanto/{id}")
	Response modificar(@PathParam("idPersonal") String idPersonal, AdelantoDTO obj);

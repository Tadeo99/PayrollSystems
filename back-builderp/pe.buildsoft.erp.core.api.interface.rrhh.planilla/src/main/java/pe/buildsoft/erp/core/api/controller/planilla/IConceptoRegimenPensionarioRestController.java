 ...
 */
@Tag(name = "/conceptoRegimenPensionario", description = "Planilla Service")
...
public interface IConceptoRegimenPensionarioRestController {

	@POST
	Response crear(ConceptoRegimenPensionarioDTO obj);

	@PUT
	@Path("/{id}")
	Response modificar(ConceptoRegimenPensionarioDTO obj);

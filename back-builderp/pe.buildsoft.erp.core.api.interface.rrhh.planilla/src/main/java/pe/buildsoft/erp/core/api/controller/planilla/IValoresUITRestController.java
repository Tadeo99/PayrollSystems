 ...
 */
@Tag(name = "/valoresUIT", description = "Planilla Service")
...
public interface IValoresUITRestController {

	@POST
	Response crear(ValoresUITDTO obj);

	@PUT
	@Path("/{id}")
	Response modificar(ValoresUITDTO obj);
	...
	@POST
	@Path("/find")
	Response find(ValoresUITDTO filtro);
}
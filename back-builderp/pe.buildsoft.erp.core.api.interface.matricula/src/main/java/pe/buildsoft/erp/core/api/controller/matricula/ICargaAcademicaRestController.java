 ...
 */
@Tag(name = "/cargaAcademica", description = "Matricula Service")
...
public interface ICargaAcademicaRestController {

	@POST
	Response agregarCursoCargaLectiva(@Context HttpHeaders headers, CargaAcademicaDTO obj);

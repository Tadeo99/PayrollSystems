 ...
 */
@Tag(name = "/periodo", description = "Matricula Service")
...
public interface IPeriodoRestController {

	@POST
	Response crear(PeriodoDTO obj);

	@PUT
	@Path("/{id}")
	Response modificar(PeriodoDTO obj);
	...
	@POST
	@Path("/find")
	Response findPeriodo(PeriodoDTO periodo);

 ...
 */
@Tag(name = "/calendarioAcademico", description = "Matricula Service")
...
public interface ICalendarioAcademicoRestController {

	@POST
	Response crear(CalendarioAcademicoDTO obj);

	@PUT
	@Path("/{id}")
	Response modificar(CalendarioAcademicoDTO obj);

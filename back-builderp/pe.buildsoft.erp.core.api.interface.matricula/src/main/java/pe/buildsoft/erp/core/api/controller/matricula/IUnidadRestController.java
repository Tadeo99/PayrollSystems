 ...
 */
@Tag(name = "/unidad", description = "Matricula Service")
...
public interface IUnidadRestController {

	@POST
	Response crear(UnidadDTO obj);

	@PUT
	@Path("/{id}")
	Response modificar(UnidadDTO obj);
	...
	@POST
	@Path("/find")
	Response findUnidad(UnidadDTO unidad);
}
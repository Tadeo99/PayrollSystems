...
/**
 * La Class IAlumnoRestController.
 * <ul>
...
@Tag(name = "/alumno", description = "Matricula Service")
...
public interface IAlumnoRestController {

	@POST
	Response crear(@Context HttpHeaders headers, AlumnoDTO obj);

	@PUT
	@Path("/{id}")
	Response modificar(@Context HttpHeaders headers, AlumnoDTO obj);

 ...
 */
@Tag(name = "/matricula", description = "Matricula Service")
...
public interface IMatriculaRestController {

	@POST
	Response crear(@Context HttpHeaders headers, MatriculaDTO obj);

	@PUT
	@Path("/{id}")
	Response modificar(MatriculaDTO obj);
	...
	Response obtenerMatricula(@PathParam("idAnhio") Long idAnhio, @PathParam("idAlumno") String idAlumno,

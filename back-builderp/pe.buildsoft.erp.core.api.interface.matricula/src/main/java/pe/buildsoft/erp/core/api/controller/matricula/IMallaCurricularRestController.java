 ...
 */
@Tag(name = "/mallaCurricular", description = "Matricula Service")
...
public interface IMallaCurricularRestController {

	@POST
	Response crear(MallaCurricularDTO obj);

	@PUT
	@Path("/{id}")
	Response modificar(MallaCurricularDTO obj);

 ...
 */
@Tag(name = "/grupo", description = "Matricula Service")
...
public interface IGrupoRestController {

	@POST
	Response crear(GrupoDTO obj);

	@PUT
	@Path("/{id}")
	Response modificar(GrupoDTO obj);
	...
	@POST
	@Path("/find")
	Response findGrupo(GrupoDTO grupo);
}
 ...
 */
@Tag(name = "/preRequisito", description = "Matricula Service")
...
public interface IPreRequisitoRestController {

	@POST
	Response crear(PreRequisitoDTO obj);

	@PUT
	@Path("/{id}")
	Response modificar(PreRequisitoDTO obj);

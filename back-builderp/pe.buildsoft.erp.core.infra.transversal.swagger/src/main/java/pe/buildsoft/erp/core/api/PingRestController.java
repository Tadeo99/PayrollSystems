...
public class PingRestController extends GenericServiceRestImpl implements IPingRestController {

	private Logger log = LoggerFactory.getLogger(PingRestController.class);

	@GET
	public Response paginador(@Context HttpHeaders headers, @Context UriInfo info) {
		RespuestaWSVO<String> resultado = new RespuestaWSVO<>();
		try {
			resultado.setObjetoResultado("Ping " + FechaUtil.obtenerFechaActual());
		} catch (Exception e) {

 ...
 * @since Rep v1..0
 */
public class GenericEscalafonDAOImpl<K, T> extends GenericOperacionDAOImpl<K, T> {

	private Logger log = LoggerFactory.getLogger(GenericEscalafonDAOImpl.class);
	/** El objeto entity manager. */
	@PersistenceContext(unitName = ConfiguracionEntityManagerUtil.PU_ESCAL)
	private EntityManager entityManager;

	public GenericEscalafonDAOImpl() {
		// Constructor
	}

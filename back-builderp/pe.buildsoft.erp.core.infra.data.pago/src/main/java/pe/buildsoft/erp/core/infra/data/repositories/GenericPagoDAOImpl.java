 ...
 * @since Rep v1..0
 */
public class GenericPagoDAOImpl<K, T> extends GenericOperacionDAOImpl<K, T> {

	private Logger log = LoggerFactory.getLogger(GenericPagoDAOImpl.class);
	/** El objeto entity manager. */
	@PersistenceContext(unitName = ConfiguracionEntityManagerUtil.PU_PAGO)
	private EntityManager entityManager;

	public GenericPagoDAOImpl() {
		// Constructor
	}

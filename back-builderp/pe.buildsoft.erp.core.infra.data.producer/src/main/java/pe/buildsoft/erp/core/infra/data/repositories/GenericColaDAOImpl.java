 ...
 * @since Rep v1..0
 */
public class GenericColaDAOImpl<K, T> extends GenericOperacionDAOImpl<K, T> {

	private Logger log = LoggerFactory.getLogger(GenericColaDAOImpl.class);
	/** El objeto entity manager. */
	@PersistenceContext(unitName = ConfiguracionEntityManagerUtil.PU_COLA)
	private EntityManager entityManager;

	public GenericColaDAOImpl() {
		// Constructor
	}

 ...
 * @since SIAA-CORE 2.1
 */
@Tag(name = "/parametro", description = "Common Service")
...
public interface IParametroRestController {

	@POST
	Response crear(ParametroDTO obj);

	@PUT
	@Path("/{id}")
	Response modificar(ParametroDTO obj);

 ...
 */
@Tag(name = "/requerimientoPersonal", description = "Hora Service")
...
public interface IRequerimientoPersonalRestController {

	@POST
	Response crear(RequerimientoPersonalDTO obj);

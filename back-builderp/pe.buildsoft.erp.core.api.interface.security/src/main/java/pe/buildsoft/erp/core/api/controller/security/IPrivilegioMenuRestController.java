 ...
 * @since SIAA-CORE 2.1
 */
@Tag(name = "/privilegioMenu", description = "Security Service")
...
public interface IPrivilegioMenuRestController {

	@POST
	Response crear(PrivilegioMenuDTO obj);

	@PUT
	@Path("/{id}")
	Response modificar(PrivilegioMenuDTO obj);

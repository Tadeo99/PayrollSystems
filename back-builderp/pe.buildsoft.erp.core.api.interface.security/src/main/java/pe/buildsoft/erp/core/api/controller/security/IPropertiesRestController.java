 ...
 * @since SIAA-CORE 2.1
 */
@Tag(name = "/properties", description = "Security Service")
...
public interface IPropertiesRestController {

	@POST
	Response crear(PropertiesDTO obj);

	@PUT
	@Path("/{id}")
	Response modificar(PropertiesDTO obj);

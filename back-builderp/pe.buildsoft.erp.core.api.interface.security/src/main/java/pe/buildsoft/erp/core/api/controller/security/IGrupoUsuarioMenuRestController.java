 ...
 * @since SIAA-CORE 2.1
 */
@Tag(name = "/grupoUsuarioMenu", description = "Security Service")
...
@Path("/grupoUsuarioMenu")
@Consumes(MediaType.APPLICATION_JSON)
@Produces(MediaType.APPLICATION_JSON)
public interface IGrupoUsuarioMenuRestController {

	@POST
	Response asociarMenuPersonalizado(@Context HttpHeaders httpHeaders, List<MenuDTO> listaMenu);

 ...
 */
@Stateless
public class VacacionesDaoImpl extends GenericPlanillaDAOImpl<String, Vacaciones> implements VacacionesDaoLocal {

	@Override
	public List<Vacaciones> listar(BaseSearch filtro) {
	...
	private Query generarQuery(BaseSearch filtro, boolean esContador) {
		...
		if (esContador) {
			jpaql.append(" select count(o.idVacaciones) from Vacaciones o ");
		} else {
			jpaql.append(" select o from Vacaciones o   ");
		}

...
@Local
public interface ConfigReporteTxtServiceLocal {
	/**
	 ...
	 */
	ConfiguracionReporteTxt controladorAccionConfiguracionReporteTxt(ConfiguracionReporteTxt obj,
	 ...
	 * @throws Exception the exception
	 */
	List<ConfiguracionReporteTxt> listarConfiguracionReporteTxt(BaseSearch filtro);

...
/**
 * La Class MDBJMSReportePreferencialServiceImpl.
 * <ul>
 ...
 * @since PWR v1.0
 */
@MessageDriven(name = "MDBJMSReportePreferencialServiceImpl", activationConfig = {
		@ActivationConfigProperty(propertyName = "destinationType", propertyValue = "jakarta.jms.Queue"),
		@ActivationConfigProperty(propertyName = "destination", propertyValue = ConfiguracionJMSUtil.QUEUE_REPORTE_PREFERENCIAL_NAME),
...
public class MDBJMSReportePreferencialServiceImpl extends MDBJMSReporteServiceImplUtil implements MessageListener {
	...
	public void onMessage(Message aMessage) {
		super.onMessage(aMessage, ConfiguracionJMSUtil.QUEUE_REPORTE_PREFERENCIAL_NAME);
	}
}
...
/**
 * La Class MDBJMSCorreoServiceImpl.
 * <ul>
 ...
 * @since PWR v1.0
 */
@MessageDriven(name = "MDBJMSCorreoServiceImpl", activationConfig = {
...
public class MDBJMSCorreoServiceImpl extends MDBJMSReporteServiceImplUtil implements MessageListener {
	...
	public void onMessage(Message aMessage) {
		super.onMessage(aMessage, ConfiguracionJMSUtil.QUEUE_CORREO_NAME);
	}
}
...
/**
 * La Class MDBJMSReportePesadoServiceImpl
 * <ul>
 ...
 * @since PWR v1.0
 */
@MessageDriven(name = "MDBJMSReportePesadoServiceImpl", activationConfig = {
		@ActivationConfigProperty(propertyName = "destinationType", propertyValue = "jakarta.jms.Queue"),
		@ActivationConfigProperty(propertyName = "destination", propertyValue = ConfiguracionJMSUtil.QUEUE_REPORTE_PESADO_NAME),
...
public class MDBJMSReportePesadoServiceImpl extends MDBJMSReporteServiceImplUtil implements MessageListener {
	...
	public void onMessage(Message aMessage) {
		super.onMessage(aMessage, ConfiguracionJMSUtil.QUEUE_REPORTE_PESADO_NAME);
	}
}
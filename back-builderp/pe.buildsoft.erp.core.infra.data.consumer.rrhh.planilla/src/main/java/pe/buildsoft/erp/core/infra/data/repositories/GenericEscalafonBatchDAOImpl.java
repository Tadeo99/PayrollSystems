 ...
 * @since Rep v1..0
 */
public class GenericEscalafonBatchDAOImpl<K, T> extends GenericOperacionDAOImpl<K, T> {

	private Logger log = LoggerFactory.getLogger(GenericEscalafonBatchDAOImpl.class);
	/** El objeto entity manager. */
	@PersistenceContext(unitName = ConfiguracionEntityManagerUtil.PU_PLANILLA_ESCALAFON)
	private EntityManager entityManager;

	public GenericEscalafonBatchDAOImpl() {
		// Constructor
	}

	@Override
	public Connection getConexionDS() throws NamingException, SQLException {
		return getConexionDSPer("java:jboss/datasources/escalafonDS");
	}

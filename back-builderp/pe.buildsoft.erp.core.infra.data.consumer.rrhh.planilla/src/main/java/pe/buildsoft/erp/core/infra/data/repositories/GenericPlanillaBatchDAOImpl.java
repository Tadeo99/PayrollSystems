 ...
 * @since Rep v1..0
 */
public class GenericPlanillaBatchDAOImpl<K, T> extends GenericOperacionDAOImpl<K, T> {

	private Logger log = LoggerFactory.getLogger(GenericPlanillaBatchDAOImpl.class);
	/** El objeto entity manager. */
	@PersistenceContext(unitName = ConfiguracionEntityManagerUtil.PU_PLANILLA_BATCH)
	private EntityManager entityManager;

	public GenericPlanillaBatchDAOImpl() {
		// Constructor
	}

 ...
 */
@Local
public interface TipoPlanillaDaoLocal extends GenericDAOLocal<String, TipoPlanilla> {
	/**
	 ...
	 */
	List<TipoPlanilla> listar(BaseSearch filtro);

...
@Directive({
    ...
    selector: '[bsScrollbar]',
    exportAs: 'bsScrollbar'
})
export class BsScrollbarDirective implements OnChanges, OnInit, OnDestroy {
    /* eslint-disable @typescript-eslint/naming-convention */
    static ngAcceptInputType_bsScrollbar: BooleanInput;
    /* eslint-enable @typescript-eslint/naming-convention */

    @Input() bsScrollbar = true;
    @Input() bsScrollbarOptions!: PerfectScrollbar.Options;
    ...
    ngOnChanges(changes: SimpleChanges): void {
        // Enabled
        if ('bsScrollbar' in changes) {
            // Interpret empty string as 'true'
            this.bsScrollbar = coerceBooleanProperty(changes['bsScrollbar'].currentValue);
        ...
        // Scrollbar options
        if ('bsScrollbarOptions' in changes) {
            // Merge the options
            this._options = merge({}, this._options, changes['bsScrollbarOptions'].currentValue);

...
import { BsHighlightService } from './highlight.service';

@Component({
    selector: 'ng-mf-bs-textarea[bs-highlight]',
    templateUrl: './highlight.component.html',
    styleUrls: ['./highlight.component.scss'],
    encapsulation: ViewEncapsulation.None,
    changeDetection: ChangeDetectionStrategy.OnPush,
    exportAs: 'bsHighlight'
})
export class BsHighlightComponent implements OnChanges, AfterViewInit {
    @Input() code!: string ;
    @Input() lang!: string;
    ...
    constructor(
        ...
        private _bsHighlightService: BsHighlightService,
    ...
    private _highlightAndInsert(): void {
        ...
        this.highlightedCode = this._domSanitizer.sanitize(SecurityContext.HTML, this._bsHighlightService.highlight(this.code, this.lang));

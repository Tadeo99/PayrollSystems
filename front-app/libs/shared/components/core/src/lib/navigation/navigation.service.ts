...
export class BsNavigationService {
    ...
    private _navigationStore: Map<string, BsNavigationItem[]> = new Map<string, any>();
     ...
     * @param navigation
     */
    storeNavigation(key: string, navigation: BsNavigationItem[]): void {
        // Add to the store
     ...
     * @param key
     */
    getNavigation(key: string): BsNavigationItem[] {
     ...
     */
    getFlatNavigation(navigation: BsNavigationItem[], flatNavigation: BsNavigationItem[] = []): BsNavigationItem[] {
     ...
     * @param navigation
     */
    getItem(id: string, navigation: BsNavigationItem[]): BsNavigationItem | null {
        for (const item of navigation) {
            if (item.id === id) {
                return item;
            }
    ...
    getItemParent(
        id: string,
        navigation: BsNavigationItem[],
        parent: BsNavigationItem[] | BsNavigationItem
    ): BsNavigationItem[] | BsNavigationItem | null {
        for (const item of navigation) {
            if (item.id === id) {
                return parent;
            }

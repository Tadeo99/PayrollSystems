...
import { EPSConfService } from "./epsconf.service";
import { EPSConf } from "./epsconf.types";
/**
 * La Class EPSConfComponent.
 * <ul>
 ...
 */
@Component({
	selector: 'ng-mf-bs-epsconf',
	templateUrl: './epsconf.component.html',
	styleUrls: ['./epsconf.component.scss'],
	encapsulation: ViewEncapsulation.None,
	changeDetection: ChangeDetectionStrategy.OnPush,
	animations: bsAnimations
})
export class EPSConfComponent extends BaseComponent<EPSConf> implements OnInit, AfterViewInit, OnDestroy {


	public listaEPS: SelectItemVO[] | undefined = [];

	idEPS = new FormControl(null);
	...
	constructor(
		...
		private service: EPSConfService,
	 ...
	 *
	 */
	public confirmarEliminar(obj: EPSConf) {
		const dialogRef = this.abrirModalConfirDialogEliminar();
		dialogRef.afterClosed().subscribe(result => {
			if (result === 'confirmed') {
				this.eliminar(obj.idEPSConf);
			}
		});
	}

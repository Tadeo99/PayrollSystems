...
export class FeriadoComponent extends BaseComponent<Feriado> implements OnInit, AfterViewInit, OnDestroy {
	...
	public nuevo() {
		...
		this.frmGroup.get("idMes")?.setValue(this.idItemByMes.value);
	 ...
	 *
	 */
	public confirmarEliminar(obj: Feriado) {
		const dialogRef = this.abrirModalConfirDialogEliminar();
		dialogRef.afterClosed().subscribe(result => {
			if (result === 'confirmed') {
				this.eliminar(obj.idFeriado);
			}
		});
	}

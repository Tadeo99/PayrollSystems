...
import { CommonService, EstadoVacacionesState } from '@ng-mf/shared/service/comun';
import { BasePagination, BsConfirmationService, TypeSelectItemService } from '@ng-mf/shared/service/core';
import { TranslocoService } from '@ngneat/transloco';
import { merge, takeUntil } from 'rxjs';
import { VacacionesService } from "./vacaciones.service";
import { Vacaciones } from "./vacaciones.types";
/**
 * La Class VacacionesComponent.
 * <ul>
...
export class VacacionesComponent extends BaseComponent<Vacaciones> implements OnInit, AfterViewInit, OnDestroy {
	...
	constructor(
		...
		this.SORT_NAME = 'conceptoPdt.descripcion';
	}
	...
	public guardar() {
		...
		try {
			if (this.accionNuevo) {
				...
				this.service.modificarPer(this.id, this.frmGroup.value, this.frmGroup.value.idAdelanto).subscribe(
					data => {
						if (this.isProcesoOK(data)) {
	...
	public nuevo() {
		this.crearFormulario();
		this.frmGroup.get("estado")?.setValue(EstadoVacacionesState.EN_SOLICITUD.toString());

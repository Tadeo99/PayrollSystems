...
import { Adelanto } from "./adelanto.types";
/**
 * La Class AdelantoComponent.
 * <ul>
...
@Component({
	selector: 'ng-mf-bs-adelanto',
	templateUrl: './adelanto.component.html',
	styleUrls: ['./adelanto.component.scss'],
	encapsulation: ViewEncapsulation.None,
	changeDetection: ChangeDetectionStrategy.OnPush,
	animations: bsAnimations
})
export class AdelantoComponent extends BaseComponent<Adelanto> implements OnInit, AfterViewInit, OnDestroy {
	...
	constructor(
		...
		private service: AdelantoService,
	 ...
	 *
	 */
	public confirmarEliminar(obj: Adelanto) {
		const dialogRef = this.abrirModalConfirDialogEliminar();
		dialogRef.afterClosed().subscribe(result => {
			if (result === 'confirmed') {
				this.eliminar(obj.idAdelanto);
			}
		});
	}

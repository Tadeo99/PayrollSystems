...
import { BsMockApiReplyCallback } from './mock-api.types';

export class BsMockApiHandler {
    request!: HttpRequest<any>;
    urlParams!: { [key: string]: string };

    // Private
    private _reply: BsMockApiReplyCallback = undefined;
     ...
     * @param callback
     */
    reply(callback: BsMockApiReplyCallback): void {
        // Store the reply

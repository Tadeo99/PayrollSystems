    ...
    ngOnInit(): void {
        ...
        combineLatest([this.filters.categorySlug$, this.filters.query$, this.filters.hideCompleted$])
            .subscribe(([categorySlug, query, hideCompleted]) => {
                ...
                // Filter by completed
                if (hideCompleted && this.filteredCourses) {

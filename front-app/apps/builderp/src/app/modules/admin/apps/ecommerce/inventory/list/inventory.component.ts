...
import {
    InventoryBrand, InventoryCategory, InventoryPagination,
    InventoryProduct, InventoryTag, InventoryVendor
}
...
export class InventoryListComponent extends BaseComponent<InventoryProduct> implements OnInit, AfterViewInit, OnDestroy {
  //  @ViewChild(MatPaginator) private _paginator!: MatPaginator;
   // @ViewChild(MatSort) private _sort!: MatSort;

  //  listaData$!: Observable<InventoryProduct[]>;
   ...
   // private _unsubscribeAll: Subject<any> = new Subject<any>();
    ...
    ngOnInit(): void {
        ...
        this._inventoryService.pagination$
            .pipe(takeUntil(this._unsubscribeAll))
            .subscribe((pagination: InventoryPagination | null) => {
        ...
        // Get the products
        this.listaData$ = this._inventoryService.products$;
     ...
     * @param event
     */
    updateTagTitle(tag: InventoryTag, event: any): void {
    ...
    deleteSelectedProduct(): void {
        ...
        const confirmation = this._bsConfirmationService.open({

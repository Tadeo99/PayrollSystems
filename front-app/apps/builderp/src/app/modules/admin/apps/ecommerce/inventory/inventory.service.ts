...
export class InventoryService {
    // Private
    private _brands: BehaviorSubject<InventoryBrand[]> = new BehaviorSubject<InventoryBrand[]>([]);
    private _categories: BehaviorSubject<InventoryCategory[]> = new BehaviorSubject<InventoryCategory[]>([]);
    ...
    private _products: BehaviorSubject<InventoryProduct[]> = new BehaviorSubject<InventoryProduct[]>([]);
    private _tags: BehaviorSubject<InventoryTag[]> = new BehaviorSubject<InventoryTag[]>([]);
    private _vendors: BehaviorSubject<InventoryVendor[]> = new BehaviorSubject<InventoryVendor[]>([]);
     ...
     * @param product
     */
    updateProduct(id: string, product: InventoryProduct): Observable<InventoryProduct | null> {
        return this.products$.pipe(
            take(1),
            switchMap(products => this._httpClient.patch<InventoryProduct>('api/apps/ecommerce/inventory/product', {
                ...
                switchMap(updatedProduct => this.product$.pipe(
                    take(1),
                    filter((item: any) => item && item.id === id),
                    tap(() => {

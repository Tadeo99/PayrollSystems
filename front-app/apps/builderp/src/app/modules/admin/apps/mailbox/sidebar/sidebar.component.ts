...
import { BsNavigationItem, BsNavigationService, BsVerticalNavigationComponent } from '@bs/components/navigation';
...
@Component({
    selector     : 'ng-mf-mailbox-sidebar',
...
export class MailboxSidebarComponent implements OnInit, OnDestroy
{
    ...
    private _filtersMenuData: BsNavigationItem[] = [];
    private _foldersMenuData: BsNavigationItem[] = [];
    private _labelsMenuData: BsNavigationItem[] = [];
    private _otherMenuData: BsNavigationItem[] = [];
    ...
    private _generateFoldersMenuLinks(): void
    {
        ...
        this.folders.forEach((folder) => {
            ...
            const menuItem: BsNavigationItem = {
                id   : folder.id,
                title: folder.title,
                type : 'basic',
                icon : folder.icon,
    ...
    private _updateNavigationBadge(folders: MailFolder[]): void
    {
        ...
        const mainNavigationComponent = this._bsNavigationService.getComponent<BsVerticalNavigationComponent>('mainNavigation');

        // If the main navigation component exists...
        if ( mainNavigationComponent )
        {
            const mainNavigation = mainNavigationComponent.navigation;
            const menuItem = this._bsNavigationService.getItem('apps.mailbox', mainNavigation);

...
import { BsNavigationService, BsVerticalNavigationComponent } from '@bs/components/navigation';
import { Tag, Task } from 'app/modules/admin/apps/tasks/tasks.types';
import { TasksService } from 'app/modules/admin/apps/tasks/tasks.service';

@Component({
    selector     : 'ng-mf-tasks-list',
...
export class TasksListComponent implements OnInit, OnDestroy
{
    ...
    ngOnInit(): void
    {
            ...
            .subscribe((tasks: Task[]) => {
                ...
                setTimeout(() => {
                    ...
                    if ( mainNavigationComponent )
                    {
                        ...
                        const menuItem = this._bsNavigationService.getItem('apps.tasks', mainNavigation);
        ...
        this._bsMediaWatcherService.onMediaQueryChange$('(min-width: 1440px)')
            .pipe(takeUntil(this._unsubscribeAll))
            .subscribe((state) => {

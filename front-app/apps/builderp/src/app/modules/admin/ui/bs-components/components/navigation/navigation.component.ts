...
export class NavigationComponent
{
     ...
     */
    getNavItem(itemId, navigationName): BsNavigationItem | null
    {
        // Get the component -> navigation data -> item
        const navComponent = this._bsNavigationService.getComponent<BsVerticalNavigationComponent>(navigationName);
        ...
        const item = this._bsNavigationService.getItem(itemId, navigation);
        console.log(item);
        return item;
    }
    ...
    swapNavigationData(navigationName): void
    {
        ...
        const newNavigation: BsNavigationItem[] = [
            {

...
import { BsNavigationItem } from '../../../../../../../@bs/components/navigation/navigation.types';

@Component({
    selector     : 'ng-mf-bs-demo-sidebar',
    template     : `
        <div class="py-10">
    ...
    styles       : [
        `
            ng-mf-bs-demo-sidebar ng-mf-bs-vertical-navigation .bs-vertical-navigation-wrapper {

            ...
            changes    : [
                {
                    type: 'Fixed',
                    list: [
                        '(@bs/confirmation-dialog) Fixed: Extra padding on the confirmation dialogs',
                    ]
                }
            ]
        },
            ...
            changes    : [
                {
                    type: 'Breaking',
                    list: [
                        '(Dependencies) From this version up, Bs will not be compatible with Legacy Angular Material components',
                        ...
                        '(.bs-mat-textarea) Removed in favor of CSS :has selector, now textareas within "mat-form-field" components are detected automatically',
                        '(.bs-mat-no-subscript) Removed in favor of \'subscriptSizing="dynamic"\' property of "mat-form-field"',
                    ]
                },
                {
                    type: 'Changed',
                    list: [
                        '(Dependencies) Updated Angular & Angular Material to v15.0.0',
                        '(Dependencies) Updated various other packages',
                        '(Dependencies) Removed ngx-markdown from the package.json, it still can be used within Bs, it\'s a part of the effort to make releasing Bs updates easier',
        ...
        // v16.0.0
        {
            ...
            changes    : [
                ...
                },
                {
                    type: 'Fixed',
                    list: [
                        '(BsVerticalNavigation) Fixed: Sticky positioning breaks inside a fixed positioned parent (Firefox)',
        ...
        // v15.2.0
        {
            ...
            changes    : [
                ...
                },
                {
                    type: 'Fixed',
                    list: [
                        '(@bs/tailwind/plugins/theming) Simplified the plugin and added more detailed comments',
        ...
        // v15.1.0
        {
            ...
            changes    : [
                ...
                },
                {
                    type: 'Fixed',
                    list: [
                        '(@bs/overrides/angular-material) mat-hint position is not working correctly on fields'
                    ]
                }
            ]
        },
            ...
            changes    : [
                {
                    type: 'Added',
                    list: [
                        '(@bs/navigation) Added "fragment" and "queryParams" support along with "preserveFragment" and "queryParamsHandling" on navigation items',
                        '(@bs/overrides/quill) Added tooltip styles for better compatibility',
                        '(@bs/services/platform) Added platform checker service',
                ...
                },
                {
                    ...
                    list: [
                        ...
                        '(BsDrawer) Updated the overlay and animation handling code for better stability',
                        '(@bs/overrides/quill) Better scrolling for Quill editor',
                ...
                },
                {
                    type: 'Fixed',
                    list: [
                        '(@bs/navigation) Collapse animation doesn"t work smoothly because of the parent"s margin',
                        '(@bs/service/confirmation) Cleaned-up the dialog component',
            ...
            changes    : [
                {
                    ...
                    list: [
                        ...
                        '(@bs/navigation) Expose the width variables as css custom properties, so they can be overridden from the outside',
                        '(@bs/drawer) Expose the width variable as a css custom property, so it can be overridden from the outside',
                        '(@bs/masonry) Removed the unnecessary scss file'
                    ]
                },
                {
                    type: 'Fixed',
            ...
            changes    : [
                {
                    type: 'Added',
                    list: [
                        '(BsLoadingBar) Added the BsLoadingBar component, its helper service and its interceptor'
                    ]
                },
                {
                    type: 'Changed',
                    list: [
                        ...
                        '(BsDateRange) BREAKING: Removed the BsDateRange component, alternative: https://github.com/fetrarij/ngx-daterangepicker-material'
                    ]
                },
                {
                    type: 'Fixed',
                    list: [
                        '(@bs/overrides/angular-material) Fixed: Normal border color of the text field overrides the invalid and focus border colors on dark themes',
                        '(@bs/navigation) Don\'t need to use interpolation on scss variables anymore since Tailwind doesn\'t cause any problems with them anymore'
                    ]
                }
            ]
        },
        ...
        // v13.6.0
        {
            ...
            changes    : [
                ...
                },
                {
                    type: 'Fixed',
                    list: [
                        '(@bs/drawer) Final opacity of the overlay is not permanent due to player being destroyed right after the animation'
                    ]
                }
            ]
        },
            ...
            changes    : [
                {
                    ...
                    list: [
                        ...
                        '(@bs/theming) Better structuring on the themes.scss file',
                        '(@bs) Disabled Angular Material "theme" sanity check since we use "all-component-themes" without a color map',
                        '(apps/mailbox) Style improvements',
                        'Removed empty "styles" from component decorators',
                        'Decreased budget sizes since new Bs is a lot smaller compared to the one with the old design'
                    ]
                },
                {
                    type: 'Fixed',
                    list: [
                        '(@bs/overrides) Quill editor is not styled correctly by default',
                        '(@bs/confirmation) Dialog size cannot be updated using dialogRef\'s "updateSize" method',
            ...
            changes    : [
                {
                    type: 'Fixed',
                    list: [
                        '(bs/confirmation) Confirmation dialog colors are not optimized for the Dark mode'
                    ]
                }
            ]
        },
            ...
            changes    : [
                {
                    type: 'Added',
                    list: [
                        '(bs/confirmation) A service to quickly configure and show confirmation dialogs'
                    ]
                },
                {
                    type: 'Changed',
                    list: [
                        ...
                        '(apps/contacts) Added confirmation to the "Delete contact" action using BsConfirmationService',
                        '(apps/ecommerce/inventory) Added confirmation to the "Delete product" action using BsConfirmationService',
                        '(apps/scrumboard) Added confirmation to the "Delete list" action using BsConfirmationService',
                        '(apps/tasks) Added confirmation to the "Delete task" action using BsConfirmationService',
                        '(ui/confirmation-dialog) Created a separate page for BsConfirmationService and put the example configurator in there for better visibility',
                        '(docs) Moved Bs Components and Other Components into UI for better visibility and better categorization'
                    ]
                },
                {
                    type: 'Fixed',
            ...
            changes    : [
                {
                    type: 'Added',
                    list: [
                        '(bs/navigation) "tooltip" property to show tooltips on navigation items using MatTooltip'
                    ]
                },
                {
                    type: 'Changed',
                    list: [
                        ...
                        '(bs/navigation) Moved *ngIf directives into their own "ng-container" containers',
                        '(layouts) Hide the "bs-fullscreen" button on smaller devices since they don\'t support fullscreen',
                ...
                },
                {
                    type: 'Fixed',
                    list: [
                        '(bs/drawer) Memory leak due to the animation player, thanks to Vadym Pidoplichko for coming up the issue and the solution.',
                        '(bs/navigation) Vertical navigation blocks scroll if it\'s destroyed while in "over" mode and opened',
            ...
            changes    : [
                {
                    type: 'Added',
                    list: [
                        '(bs/fullscreen) [tooltip] & [iconTpl] inputs for customizing the trigger button',
                        '(bs/navigation) "target" property for setting the target attribute on external links',
                ...
                },
                {
                    type: 'Fixed',
                    list: [
                        '(bs/navigation) First children of collapsable items don\'t have proper spacing at the top',
        ...
        // v13.0.3
        {
            ...
            changes    : [
                ...
                },
                {
                    type: 'Changed',
                    list: [
                        '(bs/autogrow) BREAKING: Removed "bsAutogrow" in favor of "matTextareaAutosize" since all of its problems solved, use [matTextareaAutosize] without any vertical padding on the textarea itself',
            ...
            changes    : [
                {
                    ...
                    list: [
                        ...
                        '(BsNavigation) Added support for new "isActiveMatchOptions" for Basic navigation items; https://github.com/angular/angular/pull/40303'
                    ]
                },
                {
                    type: 'Changed',
                    list: [
                        ...
                        '(BsNavigation) Added a generic return type for "getComponent" method on BsNavigationService',
                        '(BsNavigation) Use the generic return type for "getComponent"',
                        '(bs) Fixed barrel exports',
            ...
            changes    : [
                {
                    ...
                    list: [
                        ...
                        '(bs/masonry) Added a component for creating fast Masonry-like layouts'
                    ]
                },
                {
                    type: 'Changed',
            ...
            changes    : [
                {
                    ...
                    list: [
                        ...
                        '(bs/fullscreen) Added fullscreen toggle component'
                    ]
                },
                {
                    type: 'Changed',
            ...
            changes    : [
                {
                    type: 'Added',
                    list: [
                        'This is the new major version of the Bs and it\'s completely different from previous versions with no upgrade path',

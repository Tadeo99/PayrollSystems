...
export const defaultNavigation: BsNavigationItem[] = [
    {
        id: 'dashboards',
        title: 'Dashboards',
    ...
    },
    {
        ...
        children: [
            ...
            {
                id: 'user-interface.bs-components',
                title: 'Bs Components',
                type: 'basic',
                icon: 'heroicons_outline:chip',
                link: '/ui/bs-components'
            },
            {
    ...
    },
    {
        id: 'documentation',
        title: 'Documentation',
        subtitle: 'Everything you need to know about Bs',
        type: 'group',
        icon: 'heroicons_outline:support',
        children: [
            {
...
export const compactNavigation: BsNavigationItem[] = [
    {
        id: 'dashboards',
        title: 'Dashboards',
        tooltip: 'Dashboards',
...
export const futuristicNavigation: BsNavigationItem[] = [
    {
        id: 'dashboards',
        title: 'DASHBOARDS',
        type: 'group',
...
export const horizontalNavigation: BsNavigationItem[] = [
    {
        id: 'dashboards',
        title: 'Dashboards',
        type: 'group',

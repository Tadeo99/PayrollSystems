...
import { BsMockApiService } from '../../../../@bs/lib/mock-api/mock-api.service';
import { labels as labelsData, notes as notesData } from './data';
import { BsMockApiUtils } from '../../../../@bs/lib/mock-api';
        ...
        this._bsMockApiService
            ...
            .reply(({ request }) => {
                ...
                this._notes = this._notes.map(note => ({
                    ...note,
                    labels: note.labels.filter((item: string | null) => item !== id)
                }));
        ...
        this._bsMockApiService
            ...
            .reply(() => {
                ...
                notes = notes.map(note => (
                    {
                        ...note,
                        labels: note.labels.map((labelId: any) => labels.find(label => label.id === labelId))
                    }
                ));

...
import { BsMockApiService, BsMockApiUtils } from '../../../../@bs/lib/mock-api';
import { boards as boardsData, cards as cardsData, labels as labelsData, lists as listsData, members as membersData } from './data';
    ...
    registerHandlers(): void {
        ...
        this._bsMockApiService
            ...
            .reply(({ request }) => {
                ...
                // Generate a new GUID
                newList.id = BsMockApiUtils.guid();
        ...
        this._bsMockApiService
            ...
            .reply(({ request }) => {
                ...
                // Generate a new GUID
                newCard.id = BsMockApiUtils.guid();
        ...
        this._bsMockApiService
            ...
            .reply(({ request }) => {
                ...
                // Generate a new GUID
                newLabel.id = BsMockApiUtils.guid();

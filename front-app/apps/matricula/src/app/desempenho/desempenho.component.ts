...
import { DialogContentOverrideCapacidad } from '../capacidad/capacidad.component';
...
export class DesempenhoComponent extends BaseComponent implements  OnInit, OnChanges,AfterViewInit {
	...
	private  crearFormulario(obj : any) : void{
		this.frmGroup = this.fb.group({
			...
			idDesempenho: [obj.idDesempenho  , [Validators.required] ],
			codigo: [obj.codigo ],
...
/**
  ...
  */   
	public abrirModalCapacidadEdit(desempenhoTemp? :any) {	
		let dialogRef = this.dialog.open(DialogContentOverrideDesempenho);	 	
	   let data = desempenhoTemp;	
...
@Component({
  ...
  export class DialogContentOverrideDesempenho extends BaseDialogContent {

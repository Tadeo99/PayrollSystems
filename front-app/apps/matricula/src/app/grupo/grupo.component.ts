...
export class GrupoComponent extends BaseComponent<Grupo> implements OnInit, AfterViewInit, OnDestroy {
	 ...
	 *
	 */
	public confirmarEliminar(obj: Grupo) {
		const dialogRef = this.abrirModalConfirDialogEliminar();
		dialogRef.afterClosed().subscribe(result => {
			if (result === 'confirmed') {
				this.eliminar(obj.idGrupo);
			}
		});
	}

...
export class PlantillaService extends BaseService<Plantilla> {
  ...
  override eliminarPer(idTecnologia: string, id: any): Observable<any> {
    this.url = "/tecnologia/" + idTecnologia + "/plantilla";
  ...
  override modificarPer(idTecnologia: string, data: any, id: any): Observable<any> {
    this.url = "/tecnologia/" + idTecnologia + "/plantilla";
  ...
  /**
     ...
     * @param search
     */
  override paginadorPer(idTecnologia: string, page: number = 0, size: number = 10, sort: string = 'nombre', order: 'asc' | 'desc' | '' = 'asc', search: string = '', paramsDinamic?: HttpParams):
    Observable<{ pagination: BasePagination; listaResultado: Plantilla[] }> {
    if (!paramsDinamic) {
    ...
    this.url = "/tecnologia/" + idTecnologia + "/plantillas";
    return this.http.get<{ pagination: BasePagination; listaResultado: Plantilla[] }>(this.modulo + this.url + '/', {

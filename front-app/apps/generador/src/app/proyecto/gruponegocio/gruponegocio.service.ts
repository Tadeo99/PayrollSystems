...
export class GrupoNegocioService extends BaseService<GrupoNegocio> {
  constructor(http: HttpClient) {
    super(http);
    this.modulo = 'generador';
    this.url = '/grupoNegocio';
  }
  override eliminarPer(idProyecto: string, id: any): Observable<any> {
    this.url = '/proyecto/' + idProyecto + '/grupoNegocio';
  ...
  override paginadorPer(
    ...
    this.url = '/proyecto/' + idProyecto + '/grupoNegocios';
    return this.http
      .get<{ pagination: BasePagination; listaResultado: GrupoNegocio[] }>(

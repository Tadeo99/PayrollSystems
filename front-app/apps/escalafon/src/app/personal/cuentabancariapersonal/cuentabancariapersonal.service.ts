/**
 * La Class CuentaBancariaPersonalService.
 * <ul>
...
export class CuentaBancariaPersonalService extends BaseService<CuentaBancariaPersonal> {
  ...
  override crearPer(idPersonal: string, data: any, moduloPer?: string): Observable<any> {
    ...
    this.url = "/personal/" + idPersonal + "/cuentaBancaria";

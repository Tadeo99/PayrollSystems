...
import { HistorialCargoAreaService } from "./historialcargoarea.service";
import { HistorialCargoArea } from "./historialcargoarea.types";


/**
 * La Class HistorialCargoAreaServiceComponent.
 * <ul>
...
@Component({
	selector: 'ng-mf-bs-historialcargoarea',
	templateUrl: './historialcargoarea.component.html',
	styleUrls: ['./historialcargoarea.component.scss'],
	encapsulation: ViewEncapsulation.None,
	changeDetection: ChangeDetectionStrategy.OnPush,
	animations: bsAnimations
})
export class HistorialCargoAreaServiceComponent extends BaseComponent<HistorialCargoArea> implements OnInit, AfterViewInit, OnDestroy {
	/** La lista Cargo. */
	...
	constructor(
		...
		private service: HistorialCargoAreaService,
	...
	public guardar() {
		...
		try {
			if (this.accionNuevo) {
				...
				this.service.modificarPer(this.id, this.frmGroup.value, this.frmGroup.value.idHistorialCargoArea).subscribe(
					data => {
						if (this.isProcesoOK(data)) {
	 ...
	 *
	 */
	public confirmarEliminar(obj: HistorialCargoArea) {
		const dialogRef = this.abrirModalConfirDialogEliminar();
		dialogRef.afterClosed().subscribe(result => {
			if (result === 'confirmed') {
				this.eliminar(obj.idHistorialCargoArea);
			}
		});
	}
	 ...
	 *
	 */
	public find(obj: HistorialCargoArea) {
		try {

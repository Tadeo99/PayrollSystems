...
export class PersonalComponent extends BaseComponent<Personal> implements OnInit, AfterViewInit, OnDestroy {
	...
	onInitPanels(): void {
		...
		this.panels = [
			...
			},
			{
				...
				title: 'Direccion del Trabajador',
				description: 'Registrar direccion al Personal'
			},
			{
				id: 'cuentaBancaria',
				icon: 'heroicons_outline:user-group',
				title: 'Cuenta Bancaria',
				description: 'Registrar cuenta bancaria al Personal'
			},
			{
				id: 'contrato',
				icon: 'heroicons_outline:lock-closed',
				title: 'Contrato',
				description: 'Registrar Contratos al Personal'
			},
			{
				id: 'periodoLaboral',
				icon: 'heroicons_outline:credit-card',
				title: 'Periodo Laboral',
				description: 'Administrar Periodo Laboral al Personal'
			},
			{
				id: 'asociarCentroCosto',
				icon: 'heroicons_outline:user-group',
				title: 'Asociar Centro Costo',
				description: 'Asociar Centro de Costo al Personal'
			},
			{
				id: 'beneficiarios',
				icon: 'heroicons_outline:user-group',
				title: 'Beneficiarios',
				description: 'Beneficiarios al Personal'
			},
			{
				id: 'historialbasico',
				icon: 'heroicons_outline:user-group',
				title: 'Historial Basico',
				description: 'Historial Basico al Personal'
			},
			{
				id: 'historialcargoarea',
				icon: 'heroicons_outline:user-group',
				title: 'Historial Cargo/Area',
				description: 'Historial Cargo Area al Personal'
			}
	...
	public find(obj: Personal) {
		try {
			this.service.buscarID(obj.idPersonal).subscribe(
				data => {
					if (this.isProcesoOK(data)) {
						this.selectedData = data.objetoResultado;
						this.mostrarPanelForm = true;

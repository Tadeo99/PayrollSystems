...
export class NotesService {
    // Private
    private _labels: BehaviorSubject<Label[] | null> = new BehaviorSubject<Label[] | null>(null);
    private _note: BehaviorSubject<Note | null> = new BehaviorSubject<Note | null>(null);
    private _notes: BehaviorSubject<Note[] | null> = new BehaviorSubject<Note[] | null>(null);

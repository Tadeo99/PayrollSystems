...
@Component({
	selector: 'ng-mf-bs-anhio',
	templateUrl: './anhio.component.html',
	styleUrls: ['./anhio.component.scss'],
	encapsulation: ViewEncapsulation.None,
	changeDetection: ChangeDetectionStrategy.OnPush,
	animations: bsAnimations
})
export class AnhioComponent extends BaseComponent<Anhio> implements OnInit, AfterViewInit, OnDestroy {
	...
	public guardar() {
		...
		try {
			...
			this.commonService.removeListaSelectVOItem("anhio");
		} catch (e) {
	 ...
	 *
	 */
	public confirmarEliminar(obj: Anhio) {
		const dialogRef = this.abrirModalConfirDialogEliminar();
		dialogRef.afterClosed().subscribe(result => {
			if (result === 'confirmed') {
				this.eliminar(obj.idAnhio);
			}
		});
	}
